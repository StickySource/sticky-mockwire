...
public class MockwireConfiguredIsRequiredToTestConfiguredCodeException
  ...
  public MockwireConfiguredIsRequiredToTestConfiguredCodeException(Class<?> testClass) {
    super("You need to add @MockwireConfigured to {} in order for objects in the test context to be configured",
        testClass);
  }
}
